...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler({DatabaseException.class, NoSuchElementException.class})
    public ResponseEntity<CustomError> database(Exception e, HttpServletRequest request) {
